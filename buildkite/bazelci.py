...
DOWNSTREAM_PROJECTS_PRODUCTION = {
    ...
    "Bazel Examples": {
        ...
        "disabled_reason": "https://github.com/bazelbuild/examples/issues/114",
    },
    "Bazel Federation": {
    ...
    "rules_foreign_cc": {
        ...
        "disabled_reason": "https://github.com/bazelbuild/rules_foreign_cc/issues/308",
    },
    "rules_go": {
...
def remote_caching_flags(platform):
    ...
    platform_cache_key += ["cache-poisoning-2".encode("utf-8")]
