...
SLAVES=(
    ...
    "windows-slave /bazel-public/windows-server-2012-r2-dc-v20160112-vs2015-cpp-python windows-x86_64 europe-west1-c windows-startup-script-ps1=jenkins-slave-windows.ps1"
)
