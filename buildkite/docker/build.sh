...
docker build -f ubuntu1804/Dockerfile      --target ubuntu1804-bazel-nojava -t "gcr.io/$PREFIX/ubuntu1804/bazel:nojava" ubuntu1804
...
docker build -f debian-unstable/Dockerfile --target debian-unstable-java11  -t "gcr.io/$PREFIX/debian-unstable:java11" debian-unstable
