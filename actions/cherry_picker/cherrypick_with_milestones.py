...
for k in release_numbers_data.keys():
    ...
    try:
        ...
        cherry_picked_pr_number = 10
        issue_comment(issue_number, f"Cherry-picked in https://github.com/iancha1992/bazelbuild/pull/{cherry_picked_pr_number}", input_data["api_repo_name"], input_data["is_prod"])
