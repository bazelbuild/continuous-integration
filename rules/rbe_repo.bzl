...
def _rbe_preconfig_impl(repository_ctx):
    ...
    # We intenionally omit the `sha256` since we want the latest manifest.json by design.
    repository_ctx.download('https://storage.googleapis.com/bazel-ci/rbe-configs/manifest.json', output='manifest.json')
    manifests = json.decode(repository_ctx.read('manifest.json'))

    # manifests is a list of manifest.
    #
    # manifest is a dict with following shape:
    #
    #   {
    #     "bazel_version": "...",
    #     "toolchains": [...]
    #   }
    #
    # toolchai is a dict with following shape:
    #   {
    #     "name": "...",
    #     "url": "...",
    #     "sha256": "...", 
